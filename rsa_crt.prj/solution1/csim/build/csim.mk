...
HLS_SOURCES = ../../../../test_rsa_crt.cpp ../../../../rsa.cpp
...
$(ObjDir)/test_rsa_crt.o: ../../../../test_rsa_crt.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../test_rsa_crt.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD  $(IFLAG) $(DFLAG) -O1 -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/test_rsa_crt.d
